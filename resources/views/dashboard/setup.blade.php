...
@section('content')
    <h4>Kreirajte vlasnički račun</h4>
    <hr>
    ...
    <div class="col-md-6">
        <form class="form-horizontal" method="POST" action="{{ route('setup') }}">
            ...
            <div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="ime" placeholder="Ime" name="first_name" required
            ...
            <div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="prezime" placeholder="Prezime" name="last_name" required
                           value="{{ old('last_name') }}">
            ...
            <div class="form-group {{ $errors->has('street') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="ulica" placeholder="Ulica" name="street" required
                           value="{{ old('street') }}">
            ...
            <div class="form-group {{ $errors->has('city') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="grad" placeholder="Grad" name="city" required
                           value="{{ old('city') }}">
            ...
            <div class="form-group {{ $errors->has('zip') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="zip" placeholder="Poštanski broj" name="zip" required
                           value="{{ old('zip') }}">
            ...
            <div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="drzava" placeholder="Država" name="country" required
                           value="{{ old('country') }}">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-primary">Pokrenite aplikaciju!</button>
                </div>
            </div>
        </form>
    </div>
